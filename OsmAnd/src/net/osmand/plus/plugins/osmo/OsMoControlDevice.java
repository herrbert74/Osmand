...
import net.osmand.plus.plugins.osmo.OsMoReactor;
import net.osmand.plus.plugins.osmo.OsMoService;
import net.osmand.plus.plugins.osmo.OsMoThread;
import net.osmand.plus.plugins.osmo.OsMoTracker;
