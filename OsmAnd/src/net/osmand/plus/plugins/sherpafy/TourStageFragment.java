 ...
 * 
 */
package net.osmand.plus.plugins.sherpafy;
...
import net.osmand.plus.plugins.sherpafy.TourCommonActivity.TourFragment;
import net.osmand.plus.plugins.sherpafy.TourInformation.StageInformation;
